...
import { Input, SelectInput } from 'components/common/Input/Input';

import * as S from './ProductRegister.styled';
...
const ProductRegister = ({
    ...
    return (
        <S.ProductRegisterForm onSubmit={handleSubmit(submitProduct)}>
            <fieldset>
                <SelectInput
                    label={'카테고리'}
                    id={'category'}
