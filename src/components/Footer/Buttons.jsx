...
export const HomeBtn = ({ hover, handleHover }) => {
    return (
        <button
            type="button"
...
export const BrowseBtn = ({ hover, handleHover }) => {
    return (
        <button
            type="button"
            onMouseEnter={handleHover}
...
export const AddBtn = ({ hover, handleHover }) => {
    return (
        <button
            type="button"
            onMouseEnter={handleHover}
...
export const ChatBtn = ({ hover, handleHover }) => {
    return (
        <button
            type="button"
            onMouseEnter={handleHover}
...
export const UserBtn = ({ hover, handleHover }) => {
    return (
        <button
            type="button"
            onMouseEnter={handleHover}
